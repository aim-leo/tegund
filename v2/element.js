...
const pwd = string().pattern(
  /^[a-zA-Z]\w{5,17}$/,
  '请输入一个6-18位的密码,需包含数字和字母'
)

const strongPwd = string().pattern(
  /^(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,20}$/,
